                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{Auth::guard('web')->user()->userImage}}"
                                    alt="User Image">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    {{-- @can('user.create') --}}
                                    <li><a href="{{route('attendance.getStudentAttendance')}}"><i class="typcn typcn-media-record"></i>My Attendance</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    {{-- @can('user.create') --}}
                                    <li><a href="#"><i class="typcn typcn-media-record"></i>Lectures</a></li>
