                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-4">
                                            <form class="form-horizontal" method="POST" action="{{ route('admin.login') }}">
                                                ...
                                                <div class="mb-4">
                                                    <label for="cnic">Username</label>
                                                    <input type="text" name="username" id="username" class="form-control form-control-lg" value="{{ old('username') }}" placeholder="Username" autocomplete="off" autofocus required />
                                                </div>
