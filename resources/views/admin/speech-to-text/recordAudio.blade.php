...
{{-- <!DOCTYPE html>
    ...
    <body> --}}
        <div class="container">
            ...
            {{-- <p><a c    lass="tz-link" href="https://tutorialzine.com/2017/08/converting-from-speech-to-text-with-javascript">Read the full article on Tutorialzine »</a></p> --}}
...
@section('js')
        ...
        <script src="{{asset('/skote/assets/js/script.js')}}"></script>
@endsection
